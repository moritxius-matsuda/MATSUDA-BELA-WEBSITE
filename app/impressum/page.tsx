        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="glass-card p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-4 sm:space-y-6 text-white/90 text-sm sm:text-base">
              <div>
                <h2 className="text-lg sm:text-lg sm:text-xl font-semibold text-white mb-2">Anbieterkennzeichnung nach § 5 DDG</h2>
                <p>Andreas Meier<br />
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Verantwortlich gemäß § 18 MStV</h2>
                <p>Andreas Meier</p>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Betrieben durch</h2>
                <p>Moritz Béla Meier, vertreten durch seinen gesetzlichen Vertreter Andreas Meier</p>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Kontakt</h2>
                <p>E-Mail: behoerde@moritxius.de<br />
                Telefon: +49 651 6860593</p>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2 break-words">Verbraucherstreitbeilegung/Universalschlichtungsstelle</h2>
                <p>Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Hinweis zur Online-Streitbeilegung gemäß Art. 14 Abs. 1 ODR-VO</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Urheberrechtlicher Hinweis</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Haftungsausschluss</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">Änderungen</h2>
          ...
          <div className="glass-card p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-4 sm:space-y-6 text-white/90 text-sm sm:text-base">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">1. Verantwortlicher</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">2. Datenschutzbeauftragter</h2>
                <p>Wir haben keinen Datenschutzbeauftragten benannt, da wir nicht gesetzlich dazu verpflichtet sind.</p>
              </div>

              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">3. Erhobene Daten und Verarbeitungszwecke</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">4. Datenweitergabe an Dritte</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">5. Aufbewahrungsdauer</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">6. Betroffenenrechte</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">7. Sicherheit</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">8. Aktualität und Änderungen</h2>

...
export default function Navbar() {
  ...
  return (
    <nav className="glass-navbar fixed top-0 left-0 right-0 z-50 dark:bg-black/30">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {user && isAdmin && (
              <a 
                href="https://www.moritxius.de/admin/blobs" 
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 text-white/80 md:hover:text-white md:hover:glass-button flex items-center"
              >
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              {user && isAdmin && (
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-3 py-2 rounded-md text-base font-medium transition-all duration-300 text-white/80 flex items-center"
                  onClick={() => setIsMenuOpen(false)}
                >
